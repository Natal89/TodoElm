...
var $author$project$Main$init = function (_v0) {
	return _Utils_Tuple2(
		{todo: '', todoList: _List_Nil},
		$elm$core$Platform$Cmd$none);
};
var $elm$core$Platform$Sub$batch = _Platform_batch;
var $elm$core$Platform$Sub$none = $elm$core$Platform$Sub$batch(_List_Nil);
var $author$project$Main$Todo = F3(
	function (id, todo, completed) {
		return {completed: completed, id: id, todo: todo};
	});
var $author$project$Main$update = F2(
	function (msg, model) {
		if (msg.$ === 'GotTodo') {
			...
			var todoList = _Utils_ap(
				model.todoList,
				_List_fromArray(
					[
						A3($author$project$Main$Todo, 0, model.todo, false)
					]));
			return _Utils_Tuple2(
				_Utils_update(
					model,
...
var $author$project$Main$SubmitTodo = {$: 'SubmitTodo'};
...
var $author$project$Main$mainInput = function (input_) {
	return A2(
		$elm$html$Html$input,
		_List_fromArray(
			[
				...
				$elm$html$Html$Attributes$value(input_),
				$elm$html$Html$Events$onInput($author$project$Main$GotTodo),
				$author$project$Main$onEnter($author$project$Main$SubmitTodo)
			]),
		_List_Nil);
};
...
var $author$project$Main$todoItem = function (todo) {
	var checked = todo.completed ? _List_fromArray(
		[
			...
			[
				...
				_List_fromArray(
					[
						...
						$elm$html$Html$Attributes$value(todo.todo)
					]),
				_List_Nil)
			]));
};
var $author$project$Main$mainTodos = function (todos) {
	return ($elm$core$List$length(todos) > 0) ? A2(
		...
		_List_fromArray(
			[
				...
				A2($elm$core$List$map, $author$project$Main$todoItem, todos))
			])) : $elm$html$Html$text('');
};
			...
			[
				...
				_List_fromArray(
					[
						...
						$author$project$Main$mainInput(model.todo)
					])),
				$author$project$Main$mainTodos(model.todoList),
				A2(
...
_Platform_export({'Main':{'init':$author$project$Main$main(
	$elm$json$Json$Decode$succeed(_Utils_Tuple0))({"versions":{"elm":"0.19.1"},"types":{"message":"Main.Msg","aliases":{},"unions":{"Main.Msg":{"args":[],"tags":{"GotTodo":["String.String"],"SubmitTodo":[]}},"String.String":{"args":[],"tags":{"String":[]}}}}})}});}(this));